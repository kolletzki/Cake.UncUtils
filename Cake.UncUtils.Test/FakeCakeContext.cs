...
namespace Cake.UncUtils.Test
{
    public class FakeCakeContext
    {
        ...
        {
            WorkingDirectory =
                new DirectoryPath(System.IO.Path.GetFullPath(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../")));
            ...
            CakeContext = new CakeContext(fileSystem, environment, globber, _log, args, processRunner, registry, toolLocator, dataService);
